<?php
if(!empty($pid)){
    $payment = $this->db->get_where('payments',array('id'=>$pid))->row();
...
<div class="container-fluid">
    <div class="row">
        ...
        <select name="payment_method" id="payment_method" class="custom-select default-browser custom-select-sm">
    ...
    <div class="row">
        <div class="col-md-12 ">
            ...
            <small><i>Leave this blank to auto generate otherwise enter #.</i></small>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 ">
...
$(document).ready(function(){
    $('#manage-payments').submit(function(e){
        ...
        start_load()
        $.ajax({
            url:"<?php echo base_url('sales/save_payment') ?>",
            method:'POST',
            data:$(this).serialize(),
